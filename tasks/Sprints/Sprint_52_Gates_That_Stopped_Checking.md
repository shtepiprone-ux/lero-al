...
|---|---|---|---|
| **52.1** | **722** — `KICKOFF FILED` | **732** | Both are assertion-logic defects in adjacent functions of `check-stories-rendered.mjs`, provable in **one** sweep at a **fixed** 1184-cell denominator |
