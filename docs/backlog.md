...
**Task numbering — last used: 544. Next free: 545.**
...
**🖊 Task 544 (Sprint 40 / Epic MM Phase-1 · P1.24 Skeleton) — OPEN, ✅ kickoff written.** Mantine `Skeleton` → TailAdmin (extract a new §6x reference row FIRST; primitive + story only, zero consumer migration; loader-allowlist like Progress/Task 542). Kickoff: `tasks/Sprints/Sprint_40_kickoff_prompt_Task_544_SkeletonPrimitiveTailAdmin.md`. **Remaining Phase-1 primitives after 544:** P1.25 Separator · P1.26 ScrollArea · P1.27 Slider · P1.29 Toast.
