...
|---|---|---|---|---|
| **790 · R1** | `theme.d69-18` contract check tolerates TypeScript non-null assertions — `FooterView` `footerGridGap` false red | **P1** | **Q1** | 📝 **KICKOFF FILED** 2026-09-18 → [`Sprint_77_kickoff_prompt_Task_790_R1_…`](Sprint_77_kickoff_prompt_Task_790_R1_FooterView_Non_Null_Source_Assertion.md) |
