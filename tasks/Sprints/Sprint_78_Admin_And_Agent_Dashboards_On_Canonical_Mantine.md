...
| **845** | `@mantine/charts` + `MantineDashboardLineChart` and `MantineDashboardDonut` with text alternatives | P1 | Q3 | 843, 844 | 🔁 `NEEDS REVISION` 2026-09-19 (review 2; ApexCharts, six patterns — kickoff §16 + §17; OD-1/OD-2 open, OD-1 gates 853/855) → [`…_Task_845_…`](Sprint_78_kickoff_prompt_Task_845_Dashboard_Chart_Patterns.md) |
