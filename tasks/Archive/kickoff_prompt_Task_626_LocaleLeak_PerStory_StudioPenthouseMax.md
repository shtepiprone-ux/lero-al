...
- Parent context: `tasks/Archive/kickoff_prompt_Task_625_Q0R_WarnOnly_Landing.md` (R5 paragraph) and `docs/sessions/2026-07-19-task624-locale-leak-mantine-allowlist.md` (the P2 finding).
