  ...
  render: () => (
    <div className="w-full bg-muted/30 py-8">
      <div className="container-wide mx-auto px-4">
        <DemoBox label=".container-wide — max 88rem (1408px) — public pages" />
      </div>
    </div>
  ),
  parameters: {
  ...
  render: () => (
    <div className="w-full bg-muted/30 py-8">
      <div className="max-w-5xl mx-auto px-4">
        <DemoBox label="max-w-5xl mx-auto — auth/cabinet pages (~64rem)" />
      </div>
    </div>
  ),
  ...
  render: () => (
    <div className="w-full bg-muted/30 py-8">
      <div className="max-w-6xl mx-auto p-6 lg:p-8">
        <DemoBox label="max-w-6xl mx-auto p-6 lg:p-8 — admin content" />
      </div>
    </div>
  ),
  parameters: { layout: 'fullscreen' },
...
export const AllContainers: Story = {
  render: () => (
    <div className="space-y-4 w-full">
      <div className="container-wide mx-auto px-4">
        <DemoBox label=".container-wide (88rem) — public pages" className="border-blue-500/50 bg-blue-500/10" />
      </div>
      <div className="max-w-5xl mx-auto px-4">
        <DemoBox label="max-w-5xl — auth/cabinet" className="border-green-500/50 bg-green-500/10" />
      </div>
      <div className="max-w-3xl mx-auto px-4">
        <DemoBox label="max-w-3xl — narrow centered content" className="border-orange-500/50 bg-orange-500/10" />
      </div>
    </div>
  ),
  parameters: { layout: 'fullscreen' },
