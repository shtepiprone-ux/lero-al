...
**Opened:** 2026-09-24 · **Status:** 🟠 **OPEN** · **Landed tasks:** 5 (872, 873, 875, 876, 878) · **Kickoffs filed:** 0 · **Reserved:** 1 (879) · **Moved out:** 874 → Sprint 78 (D78-7, 2026-09-24)
...
| **879** | The header's Tailwind-reproduction CSS modules (`HeaderView`, `MobileNavDrawer`, `LocaleSwitcher`, `AuthSheet`) and the `.site-header` / `.container-wide` globals go to canonical Mantine/TailAdmin. First step: capture a TailAdmin header reference, which does not exist (clause 16a) (D81-7) | P2 | Q3 | 878 | 🔒 **RESERVED** — full text → `docs/backlog-reserved.md` |
