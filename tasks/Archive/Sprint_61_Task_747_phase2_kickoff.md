...
1. `tasks/Archive/Sprint_61_kickoff_prompt_Task_747_Ledger_State_Projection_Gate.md` — the task kickoff. Still binding in full.
...
**Preflight:** `tasks/Archive/Sprint_61_Task_747_evidence_preflight.md` §2 and §4 — read before writing anything.
...
?? tasks/Archive/Sprint_61_Task_747_phase2_kickoff.md
```
...
git --no-optional-locks hash-object -- tasks/Archive/Sprint_61_Task_747_phase2_kickoff.md    # record it; a file
...
git --no-optional-locks hash-object -- tasks/Archive/Sprint_61_Task_747_phase2_kickoff.md    # STILL the §0 value
