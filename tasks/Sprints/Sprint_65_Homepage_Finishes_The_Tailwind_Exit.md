...
| **769** | 📝 **FILED 2026-08-26 — ready for executor** | **Task-767 scanner hardening.** Missing configured TSX inputs become fatal, and Mantine theme vars stop being classified as Tailwind runtime debt — globally, per **D65-F**. `--verify-gate` grows 4 → 10 asserted outcomes. Kickoff: `tasks/Sprints/Sprint_65_kickoff_prompt_Task_769_Runtime_Token_Scanner_Hardening.md`. |
