...
| **875** | The Turnstile captcha follows the app locale: `CaptchaWidget` passes `useLocale()` to Turnstile's native `options.language` (filed 2026-09-24 by 872's O81-2 review) | P3 | Q2 | — | 📝 `KICKOFF FILED` 2026-09-24 (D81-6: `sq` → `auto`) → [`…Task_875…`](Sprint_81_kickoff_prompt_Task_875_Turnstile_Follows_App_Locale.md) |
