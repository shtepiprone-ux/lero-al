...
| **52.3** | **721** — `KICKOFF FILED` | **728** | Documentation, citations and two manifest-reading gate arms. `check-assertion-liveness.mjs` never launches a browser, so this costs no sweep at all |
