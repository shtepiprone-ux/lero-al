...
**2026-06-15 — Task 426 (governance — canonical-first / no-duplicate-class AC clause) — ✅ DONE, pending orchestrator review/commit.** Docs-only, two files: added the "Canonical-first / no-duplicate-class AC" rule to `docs/ai-behavior.md` "Canonical Task Template" → "Rules" (`docs/ai-behavior.md:861`) and a matching "Canonical-first respected (Task 426)" checkbox to `docs/orchestrator-role.md` "Review checklist" (`docs/orchestrator-role.md:237`). Codifies the escape hatch from Task 425 (canonical primitive already provides the behavior → canonical-source proof + rendered evidence, no local class duplication). File-integrity green (0 NUL, no BOM, not truncated) on both files. Log: `docs/sessions/2026-06-15-task426-canonical-first-ac-clause.md`. **Next: orchestrator reviews diff (2 files) and emits commit.**
...
**Task numbering — last used: 427 (Epic I — admin/owner full edit + full status access regardless of status). Epic II uses reserved 316–323.** **Next free (new): 428.**
...
**Task 426 (governance, ✅ DONE — pending orchestrator review/commit):** added a "canonical-first / no-duplicate-class" AC clause to the Canonical Task Template (`docs/ai-behavior.md:861`) + a matching orchestrator review-checklist item (`docs/orchestrator-role.md:237`). Docs-only, two files. Origin: Task 425 review (over-strict literal-local-diff AC where canonical `Button` already satisfied). Kickoff: `tasks/kickoff_prompt_Task_426_canonical_first_ac_clause.md`. Log: `docs/sessions/2026-06-15-task426-canonical-first-ac-clause.md`.
