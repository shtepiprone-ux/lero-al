...
**Opened:** 2026-09-23 · **Status:** 🟠 **OPEN** · **Landed tasks:** 2 (870, 881) · **Kickoffs filed:** 3 (870, 871, 881) · **Reserved:** 1 (883)
...
| **883** | The bell issues one anonymous `notifications` read on sign-out: `useNotifications.ts` calls `fetchAll()` before its `userId` guard, which since Task 881 returns **401** and logs `[notifications] fetch failed` | P3 | Q2 | 881 | reserved 2026-09-25 by 881's review (finding F3, owner-observed at O80-5 step 10) — hosted here by discovery, not goal fit; the owner may move it. Full text: `docs/backlog-reserved.md` |
