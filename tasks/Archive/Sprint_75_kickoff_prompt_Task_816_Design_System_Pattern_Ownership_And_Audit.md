...
```powershell
git add "tasks/Archive/Sprint_75_kickoff_prompt_Task_816_Design_System_Pattern_Ownership_And_Audit.md" "tasks/Sprints/Sprint_75_The_Gates_That_Report_Green_On_What_They_Cannot_See.md" "docs/backlog.md"
