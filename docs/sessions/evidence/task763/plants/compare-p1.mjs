...
const post = JSON.parse(fs.readFileSync('docs/sessions/evidence/task763/plants/capture-p1-plant.json', 'utf8'));
...
fs.writeFileSync('docs/sessions/evidence/task763/plants/p1-diff-result.json', JSON.stringify({ totalCells, deltaCount: deltas.length, deltas }, null, 2));
