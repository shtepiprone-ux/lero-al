...
**Opened:** 2026-09-24 · **Status:** 🟠 **OPEN** · **Landed tasks:** 3 (872, 873, 876) · **Kickoffs filed:** 2 (875, 878) · **Reserved:** 1 (879) · **Moved out:** 874 → Sprint 78 (D78-7, 2026-09-24)
...
| **875** | The Turnstile captcha follows the app locale: `CaptchaWidget` passes `useLocale()` to Turnstile's native `options.language` (filed 2026-09-24 by 872's O81-2 review) | P3 | Q2 | — | 🟡 `PARTIALLY VERIFIED` 2026-09-24, review 1 — implementation, plants and gates verified; approval waits only on owner **O81-6** (8 Storybook tuples) (D81-6: `sq` → `auto`) → [`…Task_875…`](Sprint_81_kickoff_prompt_Task_875_Turnstile_Follows_App_Locale.md) |
...
| **O81-6** | 875's `OWNER VISUAL QA REQUIRED` matrix, before approval: `Patterns/Mantine/AuthSheet` → `Captcha` × `en`/`it`/`uk`/`sq` × 320/1440, 8 tuples. For `sq` the widget shows your browser's language (D81-6). |
