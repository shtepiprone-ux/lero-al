...
**Opened:** 2026-09-21 · **Status:** 🟠 **OPEN** · **Landed tasks:** 2 (867, 869) · **Kickoffs filed:** 3 (867, 869, 884) · **Reserved:** 0 (868 kickoff filed in Sprint 78, 2026-09-25)
...
| **O79-5** ✅ accepted by the owner 2026-09-26 (*"Приймаю."*) | Task 869's `OWNER VISUAL QA REQUIRED` matrix: open `Patterns/Mantine/CmsPageView` in Storybook and record accepted / returned for each state × locale × viewport tuple listed in that kickoff's §13.3, plus §18 cell 6 (`RichBody` × sq/uk/it × 320: no English fixture text — owner decision 2026-09-26 replaces the locale-leak scan). No automated screenshot verdict substitutes for it. |
