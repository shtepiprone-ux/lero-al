...
**Task numbering — last used: 643 (committed); 641 applied + closed; 642 approved + closed (company-field cluster done). 644/645 done (How-it-works). 646 (block A) + 647 (block C) approved + committed. 648/649 planned (block B, PopularLocations). Next free: 648.
