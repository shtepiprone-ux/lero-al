...
| **403** | Refactor `src/components/ui/**` to tokens (visually inert) + exact-value suppression for off-scale bespoke values (policy A) | UI/styling | ✅ APPROVED + COMMITTED — handed to Sonnet | `Sprint_35_kickoff_prompt_Task_403_UIPrimitivesTokenRefactor.md` |
