...
|---------|-------|
| Total cells | 1332 |
| PASS (clean, verdict=pass) | 1223 |
| FAIL (hard defect, verdict=fail) | 82 |
...
|---|---|---|---|---|---|---|
| `mantine-primitives-popover--default` | sq | mobile-390 | `mantine-primitives-popover--default__sq__mobile-390.png` | blank-canvas |  |  |
| `mantine-primitives-tabs--default` | sq | mobile-390 | `mantine-primitives-tabs--default__sq__mobile-390.png` | blank-canvas |  |  |
