...
| **808** | The detail route logs a React `key` warning on every render — find the real array, fix it, guard it | P2 | Q2 | ⬜ `KICKOFF FILED` 2026-09-10 — filed from the owner's dev-overlay report during Task 803's review; cause deliberately NOT named (two hypotheses already refuted at source in the kickoff §3.4). → [`Sprint_71_kickoff_prompt_Task_808_…`](Sprint_71_kickoff_prompt_Task_808_Detail_Route_Missing_Key_Warning.md) |
