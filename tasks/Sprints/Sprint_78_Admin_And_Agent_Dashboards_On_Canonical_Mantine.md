...
| **846** | `MantineDashboardHeader`, `MantineDashboardPeriodControl`, `MantineDashboardGrid` + `src/lib/dashboard/period.ts` (Tirane completed periods) | P1 | Q3 | 843 | 🔴 **NEEDS REVISION** (review 1, 2026-09-20) — implemented and evidenced; blocked on the owner decision in kickoff §16.1 (R6 keyboard clause; inherited picker defect filed as **861**) → [`…_Task_846_…`](Sprint_78_kickoff_prompt_Task_846_Dashboard_Header_Period_Grid.md) |
