...
`tasks/Archive/Sprint_58_Task_749_revision_1_AdminUsersTable_ScrollArea.md`. Everything else stands as written.
...
(`tasks/Archive/Sprint_53_kickoff_prompt_Task_724R_FullWidthButtons_Revision.md:145`). That decision is now given:
...
> ⚠️ **SUPERSEDED 2026-08-15 — see `tasks/Archive/Sprint_58_Task_749_revision_1_AdminUsersTable_ScrollArea.md`.**
...
- `tasks/Archive/Sprint_53_kickoff_prompt_Task_724R_FullWidthButtons_Revision.md:145` (V4, the decision D-2
