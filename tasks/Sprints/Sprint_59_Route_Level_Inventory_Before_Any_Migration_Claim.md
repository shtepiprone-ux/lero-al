...
| # | State | Scope |
|---|---|---|
| **751** | **KICKOFF FILED** | **F1 feasibility preflight.** Is an automatic DOM→**project-placer** mapping obtainable in this build? Five pre-named controls on a seeded fixture (`/sq`, 1440×900, hydrated), three reloads on React 19.2.4, four candidate mechanisms, exact-and-automatic pass criteria. Q0. Write set: `docs/reviews/artifacts/task-667/f1/**` + own registry rows — zero `src/`, zero inventory rows. Kickoff: `Sprint_59_kickoff_prompt_Task_751_F1_DOM_Component_Mapping_Feasibility.md` |
