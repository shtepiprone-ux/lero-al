...
```powershell
git add "tasks/Archive/Sprint_75_kickoff_prompt_Task_817_Per_Surface_Census_Command.md" "tasks/Sprints/Sprint_75_The_Gates_That_Report_Green_On_What_They_Cannot_See.md" "docs/backlog.md"
