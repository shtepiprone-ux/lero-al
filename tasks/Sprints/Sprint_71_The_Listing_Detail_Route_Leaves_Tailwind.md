...
| **792** | Detail-route chrome — `ListingBackButton`, `ListingStatusBanner`, `[slug]/loading.tsx`, the section wrappers — **plus the dead "similar listings" link** | P2 | Q2 | 📋 **KICKOFF FILED** (2026-09-09) — awaiting dispatch to Sonnet. → [`Sprint_71_kickoff_prompt_Task_792_…`](Sprint_71_kickoff_prompt_Task_792_Detail_Route_Chrome_And_The_Dead_Similar_Listings_Link.md) |
