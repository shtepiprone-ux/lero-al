...
export const CABINET_LISTING_SELECT =
  'id, public_id, slug, title, price, currency, listing_type, property_type, status, is_premium, views_count, created_at, expires_at, images:listing_images(url, is_cover, "order")' as const
