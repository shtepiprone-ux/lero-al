...
**Opened:** 2026-09-24 · **Status:** 🟠 **OPEN** · **Landed tasks:** 5 (872, 873, 875, 876, 878) · **Kickoffs filed:** 1 (879) · **Reserved:** 0 · **Moved out:** 874 → Sprint 78 (D78-7, 2026-09-24)
...
| **O81-9** | 879's `OWNER VISUAL QA REQUIRED` matrix (kickoff §13.3, 7 rows, opened through the iframe URL at a set window width, because the toolbar viewport does not resize (799)), before approval. After deploy: the header at 390/1440, the drawer at 390 and one forgot-password success screen on lero.al. |
