...
| **852** | Admin shell on Mantine: `AdminShell`/`AdminSidebar`/`AdminMobileHeader`/`AdminLocaleSwitcher` through an extended `MantineAppShellFoundation` | P1 | Q3 | — | 🟡 PARTIALLY VERIFIED 2026-09-26 (review 6: code accepted; pending the owner Storybook pass) → [`…_Task_852_…`](Sprint_78_kickoff_prompt_Task_852_Admin_Shell_Mantine.md) §21 |
