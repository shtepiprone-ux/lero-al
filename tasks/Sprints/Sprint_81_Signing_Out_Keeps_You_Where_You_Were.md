...
**Opened:** 2026-09-24 · **Status:** 🟠 **OPEN** · **Landed tasks:** 4 (872, 873, 875, 876) · **Kickoffs filed:** 1 (878) · **Reserved:** 1 (879) · **Moved out:** 874 → Sprint 78 (D78-7, 2026-09-24)
...
| **878** | The header renders the real bell everywhere it is proven, and loses its inline-style hardcode. `NotificationBellView` trigger → `subtle` (the owner's Story look); the `HeaderView`/`HeaderActions` Stories render the real `NotificationBellView`, not a stand-in; 28 inline `style` objects across 9 header-tree files → Mantine props and theme tokens (D81-7) | **P2** | **Q3** | 875 | 🔁 `NEEDS REVISION` 2026-09-24 (review 4: owner returned §17.5, the badge is not round, D81-9 → kickoff §18) → [`…Task_878…`](Sprint_81_kickoff_prompt_Task_878_Header_Bell_And_Inline_Style_Hardcode.md) |
