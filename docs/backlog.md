...
**Homepage → Mantine migration — ✅ COMPLETE except HeroSearch (audit 2026-07-20; blocks A/646 + C/647 + B/648–649 all done → archive). HeroSearch = block D, Phase-2 deferred** (legacy composite, waits on Combobox-consumer migration per `docs/mantine-tailadmin-migration-tracker.md`).
