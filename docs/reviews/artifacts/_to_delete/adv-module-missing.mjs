...
const CASES = [
  ...
  { id: 'E11 ListingGallery.tsx morePhotosOverlay', before: () => cn('absolute inset-0 bg-overlay/50 flex flex-col items-center justify-center text-overlay-foreground gap-1'), after: () => cn('absolute inset-0 flex flex-col items-center justify-center gap-1') },
