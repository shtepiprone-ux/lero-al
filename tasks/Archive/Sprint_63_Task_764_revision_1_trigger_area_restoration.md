...
**Task-specific:** `tasks/Archive/Sprint_63_kickoff_prompt_Task_764_Listing_Hover_Fold.md` (the predecessor; §1's
...
Execute from `tasks/Archive/Sprint_63_Task_764_revision_1_trigger_area_restoration.md` following
